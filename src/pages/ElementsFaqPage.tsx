...
export default function ElementsFaqPage() {
  return (
                  ...
                  <div className="accordion" id="faq-accordion">
                    <div className="card active">
                      <div className="card-header">
                        <button className="btn btn-link" data-bs-toggle="collapse" data-bs-target="#faq-accordion-1">
                          Is the theme responsive and customizable?
                        </button>
                      </div>
                      <div id="faq-accordion-1" className="collapse show" data-bs-parent="#faq-accordion">
                        <div className="card-body">
                          <p>
                            Learts appears professional in design and responsive in performance. It proves to be highly customizable and efficient for building eCommerce shops. Engage yourself in the most effortless and well-appointed process with Learts.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="card">
                      <div className="card-header">
                        <button className="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#faq-accordion-2">
                          How long can I get theme updates for free?
                        </button>
                      </div>
                    ...
                    <div className="card">
                      <div className="card-header">
                        <button className="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#faq-accordion-3">
                          Is the support period extendable?
                        </button>
                      </div>
                    ...
                    <div className="card">
                      <div className="card-header">
                        <button className="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#faq-accordion-4">
                          Do you accept extra theme services?
                        </button>
                      </div>
              ...
              <div className="row">
                <div className="col">
                  <div className="accordion" id="faq-toggles">
                    <div className="card active">
                      <div className="card-header">
                        <button className="btn btn-link" data-bs-toggle="collapse" data-bs-target="#faq-toggles-1">
                          Is the theme responsive and customizable?
                        </button>
                      </div>
                    ...
                    <div className="card">
                      <div className="card-header">
                        <button className="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#faq-toggles-2">
                          How long can I get theme updates for free?
                        </button>
                      </div>
                    ...
                    <div className="card">
                      <div className="card-header">
                        <button className="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#faq-toggles-3">
                          Is the support period extendable?
                        </button>
                      </div>
                    ...
                    <div className="card">
                      <div className="card-header">
                        <button className="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#faq-toggles-4">
                          Do you accept extra theme services?
                        </button>
                      </div>
