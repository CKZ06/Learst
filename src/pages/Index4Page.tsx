          ...
          <div className="home4-slider swiper-container">
            <div className="swiper-wrapper">
              <div className="home4-slide-item swiper-slide" data-swiper-autoplay="5000">
                <div className="home4-slide-image">
                  <img src="/assets/images/slider/home4/slide-1.webp" alt="Home 4 Slider Image" />
                </div>
                <div className="home4-slide-content">
                  ...
                  <div className="link">
                    <Link to="/shop.html" className="btn btn-black btn-outline-hover-black">
                      shop now
                    </Link>
                  </div>
                </div>
              ...
              <div className="home4-slide-item swiper-slide" data-swiper-autoplay="5000">
                <div className="home4-slide-image">
                  <img src="/assets/images/slider/home4/slide-2.webp" alt="Home 4 Slider Image" />
                </div>
                <div className="home4-slide-content">
                  <span className="category">
                    HOME DECOR
              ...
              <div className="home4-slide-item swiper-slide" data-swiper-autoplay="5000">
                <div className="home4-slide-image">
                  <img src="/assets/images/slider/home4/slide-3.webp" alt="Home 4 Slider Image" />
                </div>
                <div className="home4-slide-content">
                  <span className="category">
                    HOME DECOR
            ...
            <div className="home4-slider-prev swiper-button-prev">
              <i className="ti-angle-left"></i>
            </div>
            <div className="home4-slider-next swiper-button-next">
              ...
              <div className="row justify-content-between h-100">
                <div className="col-12 learts-mb-50 mt-xl-5">
                  <blockquote className="learts-blockquote2">
                    <div className="icon">
                      <img src="/assets/images/icons/quote.webp" alt="" />
                    </div>
                    <div className="content">
                      <p>
                        Take the lead and dare to dream big, even when it seems difficult &amp; far. Now we finally did it.
                      </p>
                    </div>
                  </blockquote>
                </div>
