...
export default function ProductDetailsBackgroundPage() {
  return (
            ...
            <div className="col-lg-6 col-12 learts-mb-40">
              <div className="product-summery">
                ...
                <div className="product-description">
                  <p>
                    What’s in the box – 1 Ceramic Vase without flowers: Always use the Material of the best quality. Provides a modern &amp; stylish sense to accentuate the personality of your home decor. Perfect for homeroom and office, great for adding a decorative touch to any room’s decor. After-sales Service Quality problems occur within one-year replacement, lifetime warranty.
                  </p>
                </div>
            ...
            <div className="tab-pane fade" id="tab-reviews">
              <div className="product-review-wrapper">
                <span className="title">
                  3 reviews for Minimalist Ceramic Pot
                </span>
