...
export default function BlogMasonryRightSidebarPage() {
  return (
              ...
              <div className="row isotope-grid learts-mb-n40">
                  ...
                  <div className="blog">
                    <div className="image">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/s420/blog-1.webp" alt="Blog Image" />
                      </Link>
                    </div>
                ...
                <div className="grid-item col-md-6 col-12 learts-mb-40">
                  <div className="blog">
                    <div className="image">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/s420/blog-2.webp" alt="Blog Image" />
                      </Link>
                    </div>
                    <div className="content">
                      <ul className="meta">
                ...
                <div className="grid-item col-md-6 col-12 learts-mb-40">
                  <div className="blog">
                    <div className="image">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/s420/blog-3.webp" alt="Blog Image" />
                      </Link>
                    </div>
                    <div className="content">
                      <ul className="meta">
                ...
                <div className="grid-item col-md-6 col-12 learts-mb-40">
                  <div className="blog">
                    <div className="image">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/s420/blog-4.webp" alt="Blog Image" />
                      </Link>
                    </div>
                    <div className="content">
                      <ul className="meta">
                ...
                <div className="grid-item col-md-6 col-12 learts-mb-40">
                  <div className="blog">
                    <div className="image">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/s420/blog-5.webp" alt="Blog Image" />
                      </Link>
                    </div>
                    <div className="content">
                      <ul className="meta">
                      ...
                      <div className="desc">
                        <p>
                          The print is an 8×10. You can print it at your house or at a local print place like Costco or FedEx Office. I recommend printing on card stock. Please…
                        </p>
                      </div>
                      <Link to="/blog-details-right-sidebar.html" className="link">
                        Read More
                ...
                <div className="grid-item col-md-6 col-12 learts-mb-40">
                  <div className="blog">
                    <div className="image">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/s420/blog-6.webp" alt="Blog Image" />
                      </Link>
                    </div>
                    <div className="content">
                      <ul className="meta">
                      ...
                      <div className="desc">
                        <p>
                          In attempt to make my own state shaped necklace, I did a little researching last night and found a great tutorial on the blog, V Juliet. I had everything I needed so…
                        </p>
                      </div>
                      <Link to="/blog-details-right-sidebar.html" className="link">
                        Read More
                ...
                <ul className="widget-blogs">
                  <li className="widget-blog">
                    <div className="thumbnail">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/widget/widget-1.webp" alt="Widget Blog Post" />
                      </Link>
                    </div>
                    <div className="content">
                      <h6 className="title">
                  ...
                  <li className="widget-blog">
                    <div className="thumbnail">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/widget/widget-2.webp" alt="Widget Blog Post" />
                      </Link>
                    </div>
                    <div className="content">
                      <h6 className="title">
                  ...
                  <li className="widget-blog">
                    <div className="thumbnail">
                      <Link to="/blog-details-right-sidebar.html">
                        <img src="/assets/images/blog/widget/widget-3.webp" alt="Widget Blog Post" />
                      </Link>
                    </div>
                    <div className="content">
                      <h6 className="title">
