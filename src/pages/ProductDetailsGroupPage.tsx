...
export default function ProductDetailsGroupPage() {
  return (
            ...
            <div className="col-lg-6 col-12 learts-mb-40">
              <div className="product-summery">
                ...
                <div className="product-description">
                  <p>
                    Perfect for Equestrian homes or every horse lover. Designer premium signature aluminum is compliant with FDA regulations. Aluminum Serveware can be chilled in the freezer or refrigerator and warmed in the oven to 350.
                  </p>
                </div>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td className="thumb">
                          <img src="/assets/images/product/single/6/group-product-1.webp" alt="" />
                        </td>
                        <td className="title">
                          This item: 
                          <span>
                      ...
                      <tr>
                        ...
                        <td className="thumb">
                          <img src="/assets/images/product/single/6/group-product-2.webp" alt="" />
                        </td>
                        <td className="title">
                          <a href="#">
                            Porcelain Small Bowls
                          </a>
                        </td>
                        <td className="price">
                          <span className="pro-price">
                      ...
                      <tr>
                        ...
                        <td className="thumb">
                          <img src="/assets/images/product/single/6/group-product-3.webp" alt="" />
                        </td>
                        <td className="title">
                          <a href="#">
          ...
          <div className="tab-content product-infor-tab-content">
            ...
            <div className="tab-pane fade" id="tab-reviews">
              <div className="product-review-wrapper">
                <span className="title">
                  3 reviews for Aluminum Equestrian
                </span>
