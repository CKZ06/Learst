...
export default function ElementsButtonsPage() {
  return (
    <Layout title={'Learts – Handmade Shop eCommerce HTML Template'}>
      ...
      <div className="section section-padding">
        <div className="container">
          ...
          <div className="row align-items-center learts-mb-n20">
            <div className="col-auto learts-mb-20">
            ...
            <div className="col-auto learts-mb-20">
              <a href="#" className="btn btn-primary3">
                primary3
              </a>
            </div>
            <div className="col-auto learts-mb-20">
      ...
      {/* Default Buttons Section End */}
      {/* Outline Buttons Section Start */}
      <div className="section section-padding pt-0">
        <div className="container">
          ...
          <div className="row align-items-center learts-mb-n20">
            ...
            <div className="col-auto learts-mb-20">
              <a href="#" className="btn btn-outline-primary2">
                primary2
              </a>
            </div>
            <div className="col-auto learts-mb-20">
              <a href="#" className="btn btn-outline-primary3">
                primary3
              </a>
            </div>
            <div className="col-auto learts-mb-20">
