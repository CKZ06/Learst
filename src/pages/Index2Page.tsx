            ...
            <div className="home2-slide1-image">
              ...
              <div className="home2-slide1-product1">
                ...
                <div className="slide-product">
                  <div className="image">
                    <img src="/assets/images/slider/home2/slider-1-2.webp" alt="Slide Product Image" />
                  </div>
                  <h6 className="title">
                    Country Feast set 
                  </h6>
          ...
          <div className="home2-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-color="#F5F1F1">
            <div className="home2-slide2-image">
              ...
              <div className="home2-slide2-product1">
                ...
                <div className="slide-product">
                  <div className="image">
                    <img src="/assets/images/slider/home2/slider-2-2.webp" alt="Slide Product Image" />
                  </div>
                  <h6 className="title">
                    Country Feast set 
                  </h6>
              ...
              <div className="home2-slide2-product2">
                ...
                <div className="slide-product">
                  <div className="image">
                    <img src="/assets/images/slider/home2/slider-2-3.webp" alt="Slide Product Image" />
                  </div>
                  <h6 className="title">
                    Country Feast set 
                  </h6>
          ...
          <div className="home2-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-color="#F1DED0">
            <div className="home2-slide3-image">
              ...
              <div className="home2-slide3-product1">
                ...
                <div className="slide-product">
                  <div className="image">
                    <img src="/assets/images/slider/home2/slider-3-2.webp" alt="Slide Product Image" />
                  </div>
                  <h6 className="title">
                    Country Feast set 
                  </h6>
              ...
              <div className="home2-slide3-product2">
                ...
                <div className="slide-product">
                  <div className="image">
                    <img src="/assets/images/slider/home2/slider-3-3.webp" alt="Slide Product Image" />
                  </div>
                  <h6 className="title">
                    Country Feast set 
                  </h6>
          ...
          <div className="row learts-mb-n30">
            ...
            <div className="col-lg-5 col-md-6 col-12 ms-auto learts-mb-30">
              <div className="category-banner2">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-1.webp" alt="" />
                  </div>
            ...
            <div className="col-lg-5 col-md-6 col-12 learts-mb-30">
              <div className="category-banner2">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-2.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Kniting &amp; Sewing
            ...
            <div className="d-flex align-items-center col-lg-5 col-12 ms-auto learts-mb-30">
              <div className="sale-banner3">
                ...
                <h2 className="title" data-text="ss – 18">
                  Sale up to 10% all
                </h2>
                <a href="#" className="link">
                  ONLINE STORE
