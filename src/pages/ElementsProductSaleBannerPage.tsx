...
export default function ElementsProductSaleBannerPage() {
  return (
    <Layout title={'Learts – Handmade Shop eCommerce HTML Template'}>
      ...
      {/* Product/Sale Banner Group Three Section Start */}
      ...
      {/* Product/Sale Banner Group Three Section End */}
      {/* Product/Sale Banner Group Five Section Start */}
      <div className="section section-padding pt-0">
        <div className="container">
          {/* Section Title Start */}
          <div className="section-title2 text-center">
      ...
      {/* Product/Sale Banner Group Five Section End */}
      </>
    </Layout>
  );
}
