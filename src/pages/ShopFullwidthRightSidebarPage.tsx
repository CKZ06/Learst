...
export default function ShopFullwidthRightSidebarPage() {
  return (
                ...
                <ul className="shop-toolbar-controls">
                  ...
                  <li>
                    <div className="product-column-toggle d-none d-xl-flex">
                      <button className="toggle hintT-top" data-hint="5 Column" data-column="5">
                        <i className="ti-layout-grid4-alt"></i>
                      </button>
                      <button className="toggle active hintT-top" data-hint="4 Column" data-column="4">
                        <i className="ti-layout-grid3-alt"></i>
                      </button>
                      <button className="toggle hintT-top" data-hint="3 Column" data-column="3">
            ...
            <div className="row row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1 learts-mb-n30">
              ...
              <div className="col learts-mb-30">
                ...
                <ul className="widget-colors product-filter-widget customScroll">
                  <li>
                    <a href="#" className="hintT-top" data-hint="Black">
                      <span data-bg-color="#000000">
                        Black
                      </span>
                    </a>
                  </li>
                  <li>
                    <a href="#" className="hintT-top" data-hint="White">
                      <span data-bg-color="#FFFFFF">
                        White
                      </span>
                    </a>
                  </li>
                  <li>
                    <a href="#" className="hintT-top" data-hint="Dark Red">
                      <span data-bg-color="#b2483c">
                        Dark Red
                      </span>
                    </a>
                  </li>
                  <li>
                    <a href="#" className="hintT-top" data-hint="Flaxen">
                      <span data-bg-color="#d5b85a">
                        Flaxen
                      </span>
                    </a>
                  </li>
                  <li>
                    <a href="#" className="hintT-top" data-hint="Pine">
                      <span data-bg-color="#01796f">
                        Pine
                      </span>
                    </a>
                  </li>
                  <li>
                    <a href="#" className="hintT-top" data-hint="Tortilla">
                      <span data-bg-color="#997950">
                        Tortilla
                      </span>
                    </a>
                  </li>
