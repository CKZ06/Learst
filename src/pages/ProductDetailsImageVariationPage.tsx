...
export default function ProductDetailsImageVariationPage() {
  return (
          ...
          <div className="tab-content product-infor-tab-content">
            <div className="tab-pane fade show active" id="tab-description">
              <div className="row">
                <div className="col-lg-10 col-12 mx-auto">
                  <p>
                    This clock measures 30 x 30 cm( we can custom the size if you leave a message to us after placing the order). This lock professionally engraved on to beautiful real wood. This wooden clock is a gift that will truly be cherished forever, it will be a great wedding or anniversary gift. Add all information about customization message to us if you want to custom it.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="tab-pane fade" id="tab-reviews">
              <div className="product-review-wrapper">
                <span className="title">
                  3 reviews for Geometric Modern Clock
                </span>
