...
export default function ElementsProductsTabsPage() {
  return (
          ...
          <div className="row">
            <div className="col-12">
              <ul className="product-tab-list tab-hover2 nav">
                <li>
                  <a className="active" data-bs-toggle="tab" href="#tab-new-sale-3">
                    New arrivals
                  </a>
                </li>
                <li>
                  <a data-bs-toggle="tab" href="#tab-sale-items-3">
                    Sale items
                  </a>
                </li>
                <li>
                  <a data-bs-toggle="tab" href="#tab-best-sellers-3">
                    Best sellers
                  </a>
                </li>
              </ul>
