...
export default function ProductDetailsExtraContentPage() {
  return (
            ...
            <div className="col-lg-6 col-12 learts-mb-40">
              <div className="product-summery">
                ...
                <div className="product-description">
                  <p>
                    Square serving platter with long wooden handle makes serving an easy task. Give your beautiful kitchen a touch of handcrafted modern decor by adding this square serving platter with long wooden handle. The handle gives a stylish look to the platter and makes it easy to hold and serve.
                  </p>
                </div>
          ...
          <div className="tab-content product-infor-tab-content">
            <div className="tab-pane fade show active" id="tab-description">
              <div className="row">
                <div className="col-12 mx-auto">
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-12 learts-mb-30">
                      <div className="sale-banner7">
                        <div className="inner">
                          <div className="image">
                            <img src="/assets/images/product/single/3/banner/banner-1.webp" alt="Sale Banner Image" />
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="row learts-mb-n30">
                        <div className="col-sm-6 col-12 learts-mb-30">
                          <div className="sale-banner7">
                            <div className="inner">
                              <div className="image">
                                <img src="/assets/images/product/single/3/banner/banner-2.webp" alt="Sale Banner Image" />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-12 learts-mb-30">
                          <div className="sale-banner7">
                            <div className="inner">
                              <div className="image">
                                <img src="/assets/images/product/single/3/banner/banner-3.webp" alt="Sale Banner Image" />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-12 learts-mb-30">
                          <div className="sale-banner7">
                            <div className="inner">
                              <div className="image">
                                <img src="/assets/images/product/single/3/banner/banner-4.webp" alt="Sale Banner Image" />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-12 learts-mb-30">
                          <div className="sale-banner7">
                            <div className="inner">
                              <div className="image">
                                <img src="/assets/images/product/single/3/banner/banner-5.webp" alt="Sale Banner Image" />
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <p>
                    Lay this board along the centre of your table – whether for a mid-week supper or a dinner party, this beautiful piece will hold its own.
                  </p>
                  <p>
                    Size: Length 31 cm (41 cm inc. handle). Note: Wash and dry the boards after use. Do not leave to soak. Each Rosie Brewer board carries the maker’s mark.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="tab-pane fade" id="tab-reviews">
              <div className="product-review-wrapper">
                <span className="title">
                  3 reviews for Square Serving Platter
                </span>
