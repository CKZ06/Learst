...
export default function ElementsCategoryBannerPage() {
  return (
          ...
          <div className="row justify-content-center learts-mb-n40">
            <div className="col-lg-5 col-md-6 col-12 learts-mb-40">
              <div className="category-banner2">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-3.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Pots
                ...
                <span className="banner-desc left">
                  NEW COLLECTION
                </span>
              </div>
            </div>
            <div className="col-lg-5 col-md-6 col-12 learts-mb-40">
              <div className="category-banner2">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-4.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Home Decor
                ...
                <span className="banner-desc right">
                  BEST SELLERS
                </span>
              </div>
            </div>
          ...
          <div className="row justify-content-center learts-mb-n40">
            <div className="col-lg-5 col-md-6 col-12 learts-mb-40">
              <div className="category-banner3">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-5.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Kitchen
            ...
            <div className="col-lg-5 col-md-6 col-12 learts-mb-40">
              <div className="category-banner3">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-6.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Home Decor
