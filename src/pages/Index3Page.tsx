      ...
      <div className="section section-fluid bg-white">
        <div className="container-fluid">
          <div className="home3-slider swiper-container">
              ...
              <div className="home3-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-image="/assets/images/slider/home3/slide-1.webp">
                <div className="container">
                  <div className="home3-slide-content">
                    ...
                    <div className="link">
                      <Link to="/shop.html" className="btn btn-black btn-hover-primary">
                        shop now
                      </Link>
                    </div>
                  </div>
            ...
            <div className="home3-slider-prev swiper-button-prev">
              <i className="ti-angle-left"></i>
            </div>
            <div className="home3-slider-next swiper-button-next">
          ...
          <div className="row learts-mb-n30">
            <div className="col-xxl-6 col-xl-8 col-12 learts-mb-30">
              <div className="learts-blockquote">
                <div className="inner">
                  <h2 className="title">
                    Learts is an online shop for handicrafts and arts’ works based in the US.
                  </h2>
                  <div className="desc">
                    <p>
                      Crafting beautiful stuff with our own hands and the help from useful tools is a wonderful process, where you can enjoy yourself while pulling out some ideas and busy perfecting your work. We provide high-end unique vases, wall arts, home accessories, and furniture pieces.
                    </p>
                  </div>
                  <Link to="/about-us.html" className="link">
                    ABOUT US
                  </Link>
                </div>
              </div>
            ...
            <div className="col-xxl-3 col-xl-4 col-md-6 col-12 learts-mb-30">
              <div className="sale-banner3-1">
                <div className="image">
                  <img src="/assets/images/banner/sale/sale-banner3-1.webp" alt="" />
                </div>
            ...
            <div className="col-xxl-3 col-xl-4 col-md-6 col-12 learts-mb-30">
              <div className="category-banner3">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-7.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Home Decor
            ...
            <div className="col-xxl-3 col-xl-4 col-md-6 col-12 learts-mb-30">
              <div className="category-banner3">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-8.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Gift Ideas
            ...
            <div className="col-xxl-3 col-xl-4 col-md-6 col-12 order-xxl-6 learts-mb-30">
              <div className="instagram-banner1">
                <div className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/instagram-1.webp" alt="" />
                  </div>
                  <div className="content">
                    <div className="icon">
            ...
            <div className="col-xxl-6 col-xl-8 col-12 learts-mb-30">
              <div className="category-banner3">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s2-9.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Toys
          ...
          <div className="row row-cols-xl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 learts-mb-n40">
            <div className="col learts-mb-40">
              <div className="category-banner5">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s5-1.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Gift ideas
            ...
            <div className="col learts-mb-40">
              <div className="category-banner5">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s5-2.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Home Decor
            ...
            <div className="col learts-mb-40">
              <div className="category-banner5">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s5-3.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Toys
            ...
            <div className="col learts-mb-40">
              <div className="category-banner5">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s5-4.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Pots
            ...
            <div className="col learts-mb-40">
              <div className="category-banner5">
                <Link to="/shop.html" className="inner">
                  <div className="image">
                    <img src="/assets/images/banner/category/banner-s5-5.webp" alt="" />
                  </div>
                  <div className="content">
                    <h3 className="title">
                      Kniting &amp; Sewing
        ...
        <div className="container">
          ...
          <div className="row learts-mt-50">
            <div className="col text-center">
              <Link to="/blog-right-sidebar.html" className="btn btn-dark btn-hover-primary">
                View all post
              </Link>
            </div>
          </div>
